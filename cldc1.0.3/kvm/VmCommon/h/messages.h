...
#define KVM_MSG_BAD_MAGIC_NUMBER \
        "Bad magic number"
...
#define SVM_MSG_INVALID_TRUSTEDCP_ENTRY \
        "Invalid Trusted constant pool entry"
        
#define SVM_MSG_INVALID_DOMAINS_COUNT \
        "Invalid domains count"
        
#define SVM_MSG_BAD_CONSTANT_INDEX \
        KVM_MSG_BAD_CONSTANT_INDEX

#define SVM_MSG_BAD_TRUSTED_ATTRIBUTE_LENGTH \
        "Bad Trusted attribute length"

#define SVM_MSG_INVALID_FIELD_SETTING \
        "Invalid field accessibility setting"

#define SVM_MSG_INVALID_METHOD_SETTING \
        "Invalid method accessibility setting"

#define SVM_MSG_BAD_TRUSTED_CLASS_ACCESS_FLAGS \
        "Bad trusted class access flag"

#define SVM_MSG_DUPLICATE_TRUSTED_ATTRIBUTE \
        "Duplicate Trusted attribute"

#define SVM_MSG_TRUSTED_NOT_LAST \
        "Trusted atribute must be last"

#define SVM_MSG_FILE_ERROR \
        "Unexpected file error"

#define SVM_MSG_BAD_PERMIT \
        "Bad permit"

#define SVM_MSG_MISSING_SUBCLASS_PERMIT \
        "Missing subclass permit"

#define SVM_MSG_INVALID_CSP \
        "Invalid CSP"

#define SVM_MSG_DUPLICATE_DOMAIN_KEYS \
        "Duplicate domain keys"

#define SVM_MSG_SECURITY_ERROR \
        "Security error"

#define SVM_MSG_EXPECTED_TRUSTED_SUPERCLASS \
        "Expected trusted superclass"

#define SVM_MSG_PERMIT_ARRAY_INDEX_OUT_OF_BOUNDS \
        "Pending permits array index out of bounds"

#define SVM_MSG_REQUIRED_PRIVILEGE_IS_MISSING \
        "Required privilege is missing"

#define SVM_MSG_GRANTOR_HAS_NO_KEY \
        "Grantor has no key"
