...
METHOD getSpecialMethod(INSTANCE_CLASS thisClass, NameTypeKey key)
{
    ...
    FOR_EACH_METHOD(thisMethod, methodTable)
        /*
         * There's not reason for insisting that the special method is
         * static. Otherwise, this function be used to find the class
         * initialization method (i.e InitClassMethod).
         */
