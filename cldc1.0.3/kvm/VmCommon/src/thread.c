...
void asyncFunctionProlog() {
   /*
    * The garnage collector cannot be running because the calling thread is
    ...
    */
    if (collectorIsRunning) {
        fatalError("Collector is running on entry to asyncFunctionProlog");
    }
...
void RundownAsynchronousFunctions(void) {
    ...
    for (;;) {
        ...
        if (collectorIsRunning) {
            fatalError("Collector running in RundownAsynchronousFunctions");
        }
...
void RestartAsynchronousFunctions(void) {
    if (!collectorIsRunning) {
        fatalError("Collector not running on entry to RestartAsynchronousFunctions");
    }
