/*
 * The following is part of the pilot sys_socket.h which had to be hacked to make it build
 */
...
//===========================================================================
// Globals used by the Sockets API. These are declared in the Socket.c module
