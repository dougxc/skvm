...
public class ScrollTextBox extends TextBox implements ScrollOwner {
    ...
    public void setText(String t) {
        ...
        vsb.setBounds(xPos+originalWidth-VerticalScrollBar.SCROLL_BAR_WIDTH,
    ...
    public void paint() {
        ...
        g.drawRectangle( xPos, yPos, 
                         width, height, 
                         Graphics.ERASE, Graphics.SIMPLE );
        g.drawBorder( xPos, yPos, 
                      width + VerticalScrollBar.SCROLL_BAR_WIDTH, 
                      height, Graphics.PLAIN, Graphics.SIMPLE );
