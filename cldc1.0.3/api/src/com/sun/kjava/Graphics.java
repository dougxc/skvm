...
/*========================================================*/
     ...
     */
    public static native void drawLine(int srcX, int srcY, 
     ...
     */
     public native static void setDrawRegion(int left, int top, 
     ...
     */
    public native static void copyOffScreenRegion(int left, int top, 
            int width, int height, int dstX, int dstY,
            int mode, int srcWind, int dstWind);
