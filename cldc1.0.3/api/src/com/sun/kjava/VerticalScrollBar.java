...
public class VerticalScrollBar {
    ...
    private String downArrowPattern =
          "________"
        + "________"
        + "iiiiiiii"
        + "_iiiiii_"
     ...
     */
    public VerticalScrollBar(ScrollOwner so, int x, int y, int h, 
  ...
  protected void init(int x, int y, int h, int min, int max, int initVal) {
    ...
    public void paint() {
        ...
        g.drawLine(xPos+4, yPos+arrowHeight+1, 
                   xPos+4, yPos+height-arrowHeight-2, g.GRAY);
        g.drawLine(xPos+5, yPos+arrowHeight+2, 
                   xPos+5, yPos+height-arrowHeight-3, g.GRAY);
        g.drawLine(xPos+6, yPos+arrowHeight+1, 
                   xPos+6, yPos+height-arrowHeight-2, g.GRAY);
        ...
        g.drawRectangle(xPos+4, handlePos, 3, 
                        scrollHandleHeight, g.PLAIN, g.SIMPLE);
    }
