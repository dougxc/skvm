...
public class ManyBalls extends Spotlet {
    ...
    // The more and less button bitmap patterns
    String moreBitmapPattern =
          "___ii___"
        + "___ii___"
        + "___ii___"
        + "iiiiiiii"
    ...
    public ManyBalls(int maxBalls) {
        ...
        // create the bitmaps
        lessBitmap = new Bitmap( lessBitmapPattern, 8 );
        moreBitmap = new Bitmap( moreBitmapPattern, 8 );
