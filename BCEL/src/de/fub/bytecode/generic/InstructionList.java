 ...
 *
 * @version $Id: InstructionList.java,v 1.1.1.1 2002/05/21 20:38:49 dougxc Exp $
...
public class InstructionList implements Serializable {
  ...
  public Instruction[] getInstructions() {
    ...
    try {
      while(bytes.available() > 0) {
	instructions.addElement(Instruction.readInstruction(bytes));
      }
    } catch(IOException e) { throw new ClassGenException(e.toString()); }
  ...
  public void update() {
	...
	((InstructionListObserver)e.nextElement()).notify(this);
  }
}
