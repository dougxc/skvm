 ...
 *
 * @version $Id: ReferenceType.java,v 1.1.1.1 2002/05/21 20:38:49 dougxc Exp $
...
public class ReferenceType extends Type {
  ...
  public boolean isCastableTo(Type t){
    if(this.equals(Type.NULL))
      return true;		// If this is ever changed in isAssignmentCompatble()
  ...
  public boolean isAssignmentCompatibleWith(Type t) {
    ...
    */
	...
	if (tc instanceof ReferenceType && sc instanceof ReferenceType &&
      ...
      // one one of them "interfaces implemented by arrays" is exchanged with "'Cloneable' or
      // 'java.io.Serializable'"
      if ((T instanceof ObjectType) && (((ObjectType) T).referencesInterface())){
	if (T.equals(new ObjectType("java.lang.Cloneable"))) return true;
	if (T.equals(new ObjectType("java.io.Serializable"))) return true;
      }
    }
 ...
 /**
   ...
   * If "this" or t is Type.NULL   , then Type.OBJECT is returned.
