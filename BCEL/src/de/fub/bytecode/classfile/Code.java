 ...
 * contains information about the local variables. It also has support for
 * <em>StackMap</em> attributes which are introduced by the preverifier tool in
 * the J2ME reference implementation.
 *
 * @version $Id: Code.java,v 1.2 2002/06/07 20:45:16 dougxc Exp $
...
public final class Code extends Attribute {
       ...
       ConstantPool constant_pool) throws IOException
  {
     ...
     * `LocalVariableTable' and `StackMap'
     */
  ...
  /**
   * @return StackMap of Code, if it has one
   */
  public StackMap getStackMap() {
    for(int i=0; i < attributes_count; i++)
      if(attributes[i] instanceof StackMap)
	return (StackMap)attributes[i];
  ...
  public final String toString(boolean verbose) {
    ...
    buf = new StringBuffer("Code(max_stack = " + max_stack +
			   ...
			   Utility.codeToString(code, constant_pool, (StackMap)Attribute.getAttribute(this.attributes, "StackMap"), 0, -1, verbose));
