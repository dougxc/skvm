 ...
 *
 * @version $Id: JavaClass.java,v 1.1.1.1 2002/05/21 20:38:49 dougxc Exp $
...
public class JavaClass extends AccessFlags implements Cloneable {
  ...
  public void dump(File file) throws IOException
  {
    ...
    dump(new DataOutputStream(new FileOutputStream(file)),true);
  }
  ...
  public void dump(OutputStream file) throws IOException {
    dump(new DataOutputStream(file),true);
  }
