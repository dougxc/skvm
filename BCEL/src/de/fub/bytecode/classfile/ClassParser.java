 ...
 *
 * @version $Id: ClassParser.java,v 1.1.1.1 2002/05/21 20:38:49 dougxc Exp $
...
public final class ClassParser {
  ...
  private final void readAttributes() throws IOException, ClassFormatError
  {
    ...
    for(int i=0; i < attributes_count; i++) {
      ...
      if (attributes[i] instanceof Trusted &&
        i != attributes_count - 1)
        throw new ClassFormatError("There can only be one Trusted " +
          "attribute and it must be the last class attribute");
    }
  }
