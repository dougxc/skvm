 ...
 * of it.
 *
 * @version $Id: DefaultVisitor.java,v 1.1.1.1 2002/05/21 20:38:49 dougxc Exp $
...
public class DefaultVisitor implements Visitor {
  ...
  public void visitTrusted(Trusted trusted) { trusted.accept(visitor); }
  ...
  public void visitConstantPublicKey(ConstantPublicKey constant) { constant.accept(visitor); }
  public void visitConstantDigitalSignature(ConstantDigitalSignature constant) { constant.accept(visitor); }
  ...
  public void visitStackMap(StackMap sm) {
    sm.accept(visitor);

    StackMapEntry[] entries = sm.getEntries();
    for(int i=0; i < entries.length; i++)
      entries[i].accept(this);
  }
  public void visitStackMapEntry(StackMapEntry entry) { entry.accept(visitor); }
