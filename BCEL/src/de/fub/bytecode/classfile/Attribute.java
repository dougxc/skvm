 ...
 * <em>Synthetic</em> and <em>StackMap</em> attributes are supported. The
 * <em>Unknown</em> attribute stands for non-standard-attributes.
 *
 * @version $Id: Attribute.java,v 1.1.1.1 2002/05/21 20:38:49 dougxc Exp $
...
public abstract class Attribute implements Cloneable
{
    ...
    throws IOException, ClassFormatError, InternalError
  {
    ...
    case Constants.ATTR_TRUSTED:
      return new Trusted(name_index, length, file, constant_pool);
